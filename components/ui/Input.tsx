...
export const Input = forwardRef<HTMLInputElement, InputProps>(({ label, error, description, className = '', ...props }, ref) => {
  return (
    <div className="w-full">
      ...
      <input 
        ref={ref}
        className={`w-full bg-white text-[#002147] border rounded-sm px-4 py-3 outline-none focus:ring-1 transition-all disabled:bg-[#F3F2F1] disabled:text-gray-400 text-sm placeholder:text-[#A19F9D]
          ${error 
